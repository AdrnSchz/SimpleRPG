...
/**
 * Class to represent the specific behaviour and traits of a Warrior entity.
 * Implements the methods from the CharacterGame interface.
 *
 * @author Adrián Sánchez
 * @version 1.0 28/06/2023
 */
public class Warrior extends CharacterGame {
     ...
     */
    public Warrior(String name, String player, int xp, int body, int mind, int spirit, String classType) {
